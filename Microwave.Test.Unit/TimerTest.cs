...
namespace Microwave.Test.Unit
{
    ...
    public class TimerTest
    {
        ...
        public void Start_TimerTick_ShortEnough()
        {
            ...
            uut.Start(2); // Error: 2000 changed to 2
        ...
        public void Tick_Started_TimeRemainingCorrect(int ticks)
        {
            ...
            uut.Start(5); // Error: 5000 changed to 5

            // wait for ticks, only a little longer
            pause.WaitOne(ticks * 1000 + 100);

            Assert.That(uut.TimeRemaining, Is.EqualTo(5-ticks)); // Error: 5000 changed to 5 and removed "* 1000"
        }
    }
}